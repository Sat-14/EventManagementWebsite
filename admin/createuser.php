                ...
                <div class="container"><a class="navbar-brand" href="#" style="color: rgb(255,255,255);">MMDU Event</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                    <div
                        ...
                        <ul class="nav navbar-nav mr-auto">
                            <li class="nav-item" role="presentation"><a class="nav-link active" href="../admin/dashboard.php" style="color: rgb(255,255,255);">Dashboard</a></li>
                            <li class="nav-item" role="presentation"><a class="nav-link" href="../admin/createevent.php" style="color: rgb(255,255,255);">Create Event</a></li>
                ...
                <div style="height: 811px;">
                    <div class="row register-form">
                        <div class="col-md-8 offset-md-2">
                            <form class="custom-form" action="../admin/createusersave.php" method="post" enctype="multipart/form-data" >
                                <h1>User Form</h1>
