  ...
  <div style="background-image: url(&quot;assets/img/bg3.jpeg&quot;);height: 1200px;width: 100%;">
            ...
            <div class="container"><a class="navbar-brand" href="../app/views/index.php" style="color: rgb(255,255,255);">MMDU Event</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                <div
                    ...
                    <ul class="nav navbar-nav mr-auto">
                        ...
                        <li class="nav-item" role="presentation"><a class="nav-link" href="../api/galleryupload.php" style="color: rgb(255,255,255);">Upload</a></li>
                    </ul></div><span class="actions"> <a class="login" href="../auth/log_out.php" style="color: rgb(255,255,255);margin-right: 20px;font-size: 20px;">Logout</a></span>
    </div>
    </nav>
    <div class="card shadow-lg" style="width: 63%;margin-right: 16%;margin-left: 20%;margin-top: 7%;background-color: rgb(228,228,228);">
        <div class="card-body shadow-lg" style="height: 100%;">
            <form action="../admin/createeventsave.php" method="post" enctype="multipart/form-data" >
...
<div id="basedoneventtype"></div>
                       ...
                       <div class="form-group" style="width: 70%;">
						...
						<button class="btn btn-primary shadow-lg" type="submit" style="margin: 10%;background-color: rgb(232,44,32);"><a href="../admin/dashboard.php">Cancel</a></button></div>
                    </div>
                    <div class="col">
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            <div class="col" style="height: 20%;"><img src="../public/assets/img/fether.png" style="width: 340px;height: 420px;margin-top: 90px;"></div>
                        </div>
                    </div>
                </div>
            </form>
