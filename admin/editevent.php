...
<body style="background-image: url(&quot;bg4.jpeg&quot;);height: auto;">
    ...
    <div style="background-image: url(&quot;assets/img/bg3.jpeg&quot;);height: 1200px;width: 100%;">
        <nav class="navbar navbar-light navbar-expand-md navigation-clean-button" style="background-color: rgba(255,255,255,0);color: rgb(255,255,255);">
            <div class="container"><a class="navbar-brand" href="../app/views/index.php" style="color: rgb(255,255,255);">Company Name</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                <div
                    class="collapse navbar-collapse" id="navcol-1">
                    <ul class="nav navbar-nav mr-auto">
                        <li class="nav-item" role="presentation"><a class="nav-link" href="../admin/dashboard.php" style="color: rgb(255,255,255);">Dashboard</a></li>
                        
                        
                    </ul><span class="navbar-text actions"> <a class="login" href="#" style="color: rgb(255,255,255);margin-right: 20px;font-size: 20px;">Club/ Organizer Name</a></span></div><span class="actions"> <a class="login" href="../auth/log_out.php" style="color: rgb(255,255,255);margin-right: 20px;font-size: 20px;">Logout</a></span>
    </div>
    </nav>
               ...
               echo         "<div class='form-group' style='width: 550px;'>";
				echo		"<input class='float-right' type='file' name='thumbnail' id='uploadImage' >";
                 echo          " <h4 style='width: 200px;'>Add Thumbnail</h4>";
						echo	"<br>";
					echo		"<img src="../public/images/".$row['event_thumbnail']."' id='uploadPreview' style='width: 100px; height: 100px;'>";
                 echo       "</div>";
...
echo	"<input class='form-control' type='text' name='prize[]' placeholder='Prizes ".$i."' id='prizes_".$i."' style='width: 300px;' value='".$t[$i]."'>";
	...
	echo	"<input type='hidden' value='".$i."' id='total1'>";
                        ...
                        <button class="btn btn-primary shadow-lg" type="submit" style="margin: 50px;background-color: rgb(232,44,32);"><a href="../admin/dashboard.php">Cancel</a></button></div>
                    </div>
                    <div class="col">
                        <div class="form-row">
                            <div class="col"><img class="border rounded shadow-lg" data-aos="zoom-in" data-aos-duration="900" src="../public/assets/img/brush.jpeg" style="width: 300px;height: 300px;margin: 10px;"></div>
                        </div>
                        <div class="form-row">
                            <div class="col"><img class="border rounded shadow-lg" data-aos="zoom-in" data-aos-duration="900" data-aos-delay="500" src="../public/assets/img/pencil.jpeg" style="width: 300px;height: 300px;margin: 10px;"></div>
                        </div>
                        <div class="form-row">
                            <div class="col"><img class="border rounded shadow-lg" data-aos="zoom-in" data-aos-duration="900" src="../public/assets/img/pencil2.jpeg" style="width: 300px;height: 300px;margin: 10px;"></div>
                        </div>
                        <div class="form-row">
                            <div class="col" style="height: 500px;"><img src="../public/assets/img/fether.png" style="width: 340px;height: 420px;margin-top: 90px;"></div>
                        </div>
                    </div>
                </div>
            </form>
	...
	<script src="../public/assets/js/createevent.js"></script>
