...
<link href='https://fonts.googleapis.com/css?family=Lato' rel='stylesheet' type='text/css'>
  ...
  <link rel="stylesheet" href="../public/assets/css/Footer-Dark.css">
   ...
   <link rel="stylesheet" href="../public/assets/css/Table-with-search-1-1.css">
    <link rel="stylesheet" href="../public/assets/css/Table-with-search-1.css">
                ...
                <div class="container"><a class="navbar-brand" href="../app/views/index.php" style="color: rgb(255,255,255);">MMDU Event</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                    <div
                        ...
                        <ul class="nav navbar-nav mr-auto">
                            <li class="nav-item" role="presentation"><a class="nav-link active" href="../admin/createevent.php" style="color: rgb(255,255,255);">Create Event</a></li>
                            <li class="nav-item" role="presentation"><a class="nav-link" href="../app/views/gallery.php" style="color: rgb(255,255,255);">Gallery</a></li>
                            <li class="nav-item" role="presentation"><a class="nav-link" href="../api/galleryupload.php" style="color: rgb(255,255,255);">Upload Images</a></li>
                             <li class="nav-item" role="presentation"><a class="nav-link" href="../admin/createuser.php" style="color: rgb(255,255,255);">Create new User</a></li>
                        </ul><span class="navbar-text actions"> <a class="aboutUs" href="../app/views/aboutusAfterLogIn.php" style="color: rgb(255,255,255);margin-right: 20px;font-size: 20px;">About Us</a>
                        
                        
                        
                        <button class="btn btn-primary" type="button"><span class="actions"> 
						<a class="login" href="../auth/log_out.php" style="color: rgb(255,255,255);margin-right: 20px;font-size: 20px;">Logout</a></span></button>
                        </span>
                </div>
        </div>
        </nav>
...
?>
  ...
  <option value="literary">Literary</option>
    ...
    <script src="../public/assets/js/bs-charts.js"></script>
    <script src="../public/assets/js/dropdown-search-bs4.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-easing/1.4.1/jquery.easing.js"></script>
    <script src="../public/assets/js/Table-with-search-1.js"></script>
