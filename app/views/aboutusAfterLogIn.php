    ...
    <div>
        <div class="header-dark" style="height: 100;width: 500;">
            <nav class="navbar navbar-dark navbar-expand-md navigation-clean-search">
                <div class="container"><a class="navbar-brand" href="../../app/views/index.php">MMDU Event</a>
				...
				<span class="navbar-toggler-icon"></span></button>
                    <div class="collapse navbar-collapse"
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="nav-item" role="presentation"><a class="nav-link" href="../../admin/dashboard.php">Dashboard</a></li>
                            
                            <li class="nav-item" role="presentation"><a class="nav-link" href="galleryAfterLogIn.php">Gallery</a></li>
                            
                            <li class="nav-item" role="presentation"><a class="nav-link" href="../../api/galleryupload.php">Upload</a></li>
                        </ul>
