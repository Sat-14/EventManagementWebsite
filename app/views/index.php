...
<head>
    ...
    <link rel="stylesheet" href="../../public/assets/css/Footer-Clean.css">
    <link rel="stylesheet" href="../../public/assets/css/Social-Icons.css">
    <link rel="stylesheet" href="../../public/assets/css/styles.css">
	
	
	<link rel="stylesheet" href="../../public/assets/css/Footer-Dark.css">
       ...
       <div style="background-color:#010314;">
        ...
        <div style="background-color:#414657 ;height: 10%; filter: brightness(); position:fixed;top:0;width: 100%;z-index:1030;" >
            <nav class="navbar navbar-light navbar-expand-md navigation-clean-button" style="background-color: rgba(255,255,255,0);color: rgb(255,255,255);">
                <div class="container">
                    <a href="../../app/views/index.php"><img class="navbar-brand" src="../../public/images/Capture.png" alt="MMDU Event Hub" width="200" height="60"></a>
				...
				<span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span>
                    ...
                    <div
                        ...
                        <ul class="nav navbar-nav mr-auto">
                            <li class="nav-item" role="presentation"><a class="nav-link" href="../../app/views/gallery.php" style="color: rgb(255,255,255);">Gallery</a></li>
                            <li class="nav-item" role="presentation"><a class="nav-link" href="../../app/views/aboutus.php" style="color: rgb(255,255,255);">About us</a></li>
                        </ul>
				...
				<?php					
					...
					include(__DIR__ . '/../../auth/log_in.php');
					if(isset($_SESSION['username']) == ''){
	
					echo		"<span class='navbar-text actions'> <a class='btn bt-light' href='../../auth/login.php' style='color: rgb(255,255,255);'>Log In</a>";
					echo	"<a class='btn bt-light action-button' role='button' href='../../auth/signup.php' style='background-color:red'>Sign Up</a></span>";
						
					}
						else{
						echo	" <span><a class='btn bt-light action-button' role='button' href='../../admin/dashboard.php'>Dashboard</a></span>";
						}		
				?>
...
while($row1 = mysqli_fetch_array($result1)) {
	...
	echo "<a href='../../app/views/eventpage.php?id=".$row1['event_id']."'>";

	echo "<img src='../../public/images/".$row1['event_thumbnail']."' class='yo1'>";
 ...
 echo   "</div>";
             ...
             <div class="carousel-inner" role="listbox">
                ...
                <div class="carousel-item active">
					...
					<button id="buisness" style="padding: 0; border: none; background: none;">
                         <div class="col text-break text-center" style="padding: 10px;"><img class="rounded shadow-lg" src="../../public/assets/img/Bbusiness.jpg" style="width: 200px;height: 150px;">
                        ...
                        <div class="col text-center" style="padding: 10px;"><img class="rounded shadow-lg" src="../../public/assets/img/coding.jpg" style="width: 200px;height: 150px;">
                        ...
                        <div class="col text-center" style="padding: 10px;"><img class="rounded shadow-lg" src="../../public/assets/img/literature.jpg" style="width: 200px;height: 150px;">
                        ...
                        <div class="col text-center" style="padding: 10px;"><img class="rounded shadow-lg" src="../../public/assets/img/fashion.jpg" style="width: 200px;height: 150px;">
                            <h1 style="font-size: 22px; font-family:courier new;"><b>Fashion</b></h1>
                        </div>
						</button>
						
						<button id="law" style="padding: 0; border: none; background: none;">
                        <div class="col text-center" style="padding: 10px;"><img class="rounded shadow-lg" src="../../public/assets/img/law.jpg" style="width: 200px;height: 150px;">
                            <h1 style="font-size: 22px; font-family:courier new;"><b>Law</b></h1>
                        </div>
						</button>
						<button id="sports" style="padding: 0; border: none; background: none;">
                        <div class="col text-center" style="padding: 10px;"><img class="rounded shadow-lg" src="../../public/assets/img/sports.jpg" style="width: 200px;height: 150px;">
                ...
                <div class="carousel-item">
					...
					<button id="music" style="padding: 0; border: none; background: none;">
                        <div class="col text-center" style="padding: 10px;"><img class="rounded shadow-lg" src="../../public/assets/img/music.jpg" style="width: 200px;height: 150px;">
                            <h1 style="font-size: 22px; font-family:courier new;"><b>Music</b></h1>
                        </div>
						</button>
						<button id="health" style="padding: 0; border: none; background: none;">
                        <div class="col text-center" style="padding: 10px;"><img class="rounded shadow-lg" src="../../public/assets/img/health.jpeg" style="width: 200px;height: 150px;">
                        ...
                        <div class="col text-center" style="padding: 10px;"><img class="rounded shadow-lg" src="../../public/assets/img/finearts.jpeg" style="width: 200px;height: 150px;">
                        ...
                        <div class="col text-center" style="padding: 10px;"><img class="rounded shadow-lg" src="../../public/assets/img/theater.jpg" style="width: 200px;height: 150px;">
                        ...
                        <div class="col text-center" style="padding: 10px;"><img class="rounded shadow-lg" src="../../public/assets/img/hospitality%27.jpeg" style="width: 200px;height: 150px;">
                        ...
                        <div class="col text-center" style="padding: 10px;"><img class="rounded shadow-lg" src="../../public/assets/img/dance.jpeg" style="width: 200px;height: 150px;">
    ...
    <div style="height:100%;margin:30px; background-image: url(&quot;../../public/assets/img/bg2.jpg&quot;);">
...
$eventid = ''; // Initialize event ID variable
while($row = mysqli_fetch_array($result)) {


  echo "<article class='eventCard__item item-2'>";
	echo			"<div class='item-2-img'>";
	echo				"<img src='../../public/images/".$row['event_thumbnail']."'>";
	...
	echo				"<h3 class='name'><a href='../../app/views/eventpage.php?id=".$row['event_id']."'>".$row['event_title']."</a></h3>";
	...
	$eventid = $row['startdate']; // Store last event date
}
...
<center>	<button type="button" name="btn_more" data-vid="<?php echo $eventid; ?>" id="btn_more">Load More</button>	</center>
    ...
    <script src="../../public/assets/js/bs-animation.js"></script>
            ...
            <div class="container">
                <div class="row justify-content-center">
					...
					<div class="col-sm-4 col-md-3 item social" style="margin left:-30px">
										...
										<img width="185px" height="70px" align="left" src="../../public/images/website-logo.png"><br><br><br>
