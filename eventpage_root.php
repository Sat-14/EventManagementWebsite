...
<head>
    ...
    <link rel="stylesheet" href="public/assets/css/Header-Blue.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/animate.css/3.5.2/animate.min.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/aos/2.1.1/aos.css">
    <link rel="stylesheet" href="public/assets/css/styles.css">
    <link rel="stylesheet" href="public/assets/css/Footer-Dark.css">
    <link rel="stylesheet" href="public/css/registration-form.css">
...
?>
    ...
    <div class="text-center" style="height: 20%;">
        <div style="background-image: url(&quot;public/assets/img/band-playing-on-stage-2747446.jpg&quot;);height: 350px;">
            <nav class="navbar navbar-light navbar-expand-md navigation-clean-button" style="background-color: rgba(255,255,255,0);color: rgb(255,255,255);">
                <div class="container"><a class="navbar-brand" href="app/views/index.php" style="color: rgb(255,255,255);">MMDU Event</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                    <div
                        class="collapse navbar-collapse" id="navcol-1">
                        <ul class="nav navbar-nav mr-auto">
                            <li class="nav-item" role="presentation"><a class="nav-link active" href="app/views/index.php" style="color: rgb(255,255,255);">Home</a></li>
...
if(isset($_SESSION['username']) == ''){
		...
		echo		"<span class='navbar-text actions'> <a class='login' href='auth/login.php' style='color: rgb(255,255,255);'>Log In</a>";
	echo	"<a class='btn bt-light action-button' role='button' href='auth/signup.php'>Sign Up</a></span>";
						
						}
						
						else{
						echo	" <a href='admin/dashboard.php' style='color: rgb(255,255,255);'>Dashboard</a>";
						}
...
echo "<img src='public/images/".$row['event_thumbnail']."' style='width: 100%;height: 450px;'>";
      echo        " <div>";
...
if($eventprice  != 0){
 ...
 echo "<button class='btn btn-primary btn-Oscuro' type='submit' name ='submit'>REGISTER </button>";
    ...
    <div style="height: 300px;"><img class="float-right" data-aos="slide-left" data-aos-duration="800" data-aos-delay="200" src="public/assets/img/musicLogo.jpg" style="width: 200px;"><img class="float-left" data-aos="slide-right" data-aos-duration="800" data-aos-delay="200" src="public/assets/img/writingLogo.jpg"
            style="width: 200px;"></div>
    <div style="height: 300px;"><img data-aos="slide-right" data-aos-duration="800" data-aos-delay="200" src="public/assets/img/sportsLogo.png" style="width: 200px;"><img class="float-right" data-aos="slide-left" data-aos-duration="800" data-aos-delay="200" src="public/assets/img/doctorLogo.png" style="width: 200px;height: 250px;"></div>
    <div
        style="height: 300px;"><img class="float-right" data-aos="slide-left" data-aos-duration="800" data-aos-delay="200" src="public/assets/img/danceLogo.png" style="margin: 50px;margin-right: 10px;"><img class="float-left" data-aos="slide-right" data-aos-duration="800" data-aos-delay="200"
            src="public/assets/img/coding%20logo.png" style="width: 200px;margin-top: 50px;margin-right: 50px;"></div>
