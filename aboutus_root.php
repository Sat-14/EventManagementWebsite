...
<head>
    ...
    <link rel="stylesheet" href="public/assets/css/Article-Clean.css">
    <link rel="stylesheet" href="public/assets/css/Footer-Dark.css">
    <link rel="stylesheet" href="public/assets/css/Header-Dark.css">
    <link rel="stylesheet" href="public/assets/css/Highlight-Phone.css">
    <link rel="stylesheet" href="public/assets/css/styles.css">
    <link rel="stylesheet" href="public/assets/css/Team-Boxed.css">
        <link rel="stylesheet" href="public/assets/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" href="public/assets/fonts/ionicons.min.css">
    ...
    <div>
        <div class="header-dark" style="height: 100;width: 500;">
            <nav class="navbar navbar-dark navbar-expand-md navigation-clean-search">
                <div class="container"><a class="navbar-brand" href="app/views/index.php">MMDU Event</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                    <div class="collapse navbar-collapse"
                        id="navcol-1">
                        <ul class="nav navbar-nav">
                            <li class="nav-item" role="presentation"><a class="nav-link" href="app/views/index.php">Home</a></li>
                        </ul>
                        <form class="form-inline mr-auto" target="_self">
                            <div class="form-group"><label for="search-field"></label><a href="app/views/gallery.php">Gallery</a></div>
				...
				echo		"<a class='login' href='auth/login.php'>Log In</a></span>";
				echo "<a class='btn btn-light action-button' role='button' href='auth/signup.php'>Sign Up</a>";
	
						
					}
						
						else{
						echo	"<span class='navbar-text actions'> <a href='admin/dashboard.php' style='color: rgb(255,255,255);'>Dashboard</a>";
						}
    ...
    <div class="highlight-phone">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="d-none d-md-block iphone-mockup"><img class="device" src="public/assets/img/Untitled%20design%20(10).png"></div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            ...
            <div class="row people" style="height: 400;width: 950;">
                <div class="col-md-6 col-lg-4 item">
                    <div class="box"><img class="rounded-circle" src="public/assets/img/Untitled%20design%20(6).png">
                        <h4 class="name">Ms. Gunjan Sethi</h4>
                        <p class="title">Professor</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4 item">
                    <div class="box"><img class="rounded-circle" src="public/assets/img/Untitled%20design%20(7).png">
    ...
    <div class="team-boxed">
        <div class="container">
            ...
            <div class="row people">
                <div class="col-md-6 col-lg-4 item">
                    <div class="box"><img class="rounded-circle" src="public/assets/img/Untitled%20design%20(1).png">
                    ...
                    <div class="box"><img class="rounded-circle" src="public/assets/img/Untitled%20design%20(3).png">
                ...
                <div class="col-md-6 col-lg-4 item">
                    <div class="box"><img class="rounded-circle" src="public/assets/img/Untitled%20design%20(2).png">
                    ...
                    <div class="box"><img class="rounded-circle" src="public/assets/img/Untitled%20design%20(4).png">
                ...
                <div class="col-md-6 col-lg-4 item">
                    <div class="box"><img class="rounded-circle" src="public/assets/img/Untitled%20design%20(5).png">
